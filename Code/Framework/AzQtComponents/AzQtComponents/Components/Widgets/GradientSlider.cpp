...
namespace AzQtComponents
{
    ...
    QRect GradientSlider::sliderHandleRect(
        const Style* style, const QStyleOptionSlider* option, const QWidget* widget, const Slider::Config& config)
    {
    ...
    QRect GradientSlider::sliderGrooveRect(
        const Style* style, const QStyleOptionSlider* option, const QWidget* widget, const Slider::Config& config)
    {
    ...
    bool GradientSlider::drawSlider(
        const Style* style, const QStyleOptionSlider* option, QPainter* painter, const QWidget* widget, const Slider::Config& config)
    {
        painter->save();
