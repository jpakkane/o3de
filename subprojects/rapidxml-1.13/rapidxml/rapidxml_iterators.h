...
namespace rapidxml
{
    ...
    public:
        ...
        node_iterator& operator--()
        {
            RapidXml_Assert(m_node && m_node->previous_sibling());
    ...
    public:
        ...
        attribute_iterator& operator--()
        {
            RapidXml_Assert(m_attribute && m_attribute->previous_attribute());
